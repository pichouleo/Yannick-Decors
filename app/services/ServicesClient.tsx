...
const services = [
  {
    ...
    intro: "Murs, plafonds, boiseries, escaliers… Je prends en charge l'ensemble de vos travaux de peinture intérieure avec les meilleures finitions professionnelles.",
    points: [
    ...
    detail: "Chaque chantier débute par une inspection minutieuse des supports. Je prépare soigneusement les surfaces (rebouchage, ponçage, impression) avant toute application. Le résultat final est net, homogène et durable.",
  },
  {
    id: 'exterieure',
    num: '02',
    title: 'Peinture extérieure & ravalement',
    intro: 'Façades normandes, colombages, volets et ferronneries. Je protège et embellis vos extérieurs avec des produits adaptés au climat normand.',
    points: [
    ...
    detail: "La Normandie exige des produits spécifiques résistants à l'humidité permanente. J'utilise des peintures microporeuses et des lasures professionnelles qui laissent respirer les matériaux tout en les protégeant durablement.",
  },
  {
    id: 'enduits',
    num: '03',
    title: 'Enduits & préparation des supports',
    intro: "Un bon travail de peinture commence par des supports parfaitement préparés. Je réalise tous les travaux d'enduit nécessaires à un résultat impeccable.",
    points: [
    ...
    detail: "Les maisons normandes anciennes ont souvent des murs irréguliers. Mon travail d'enduit transforme les surfaces dégradées en bases parfaites pour la peinture. Résultat : un mur lisse, solide et esthétique.",
  },
  {
    id: 'revetements',
    num: '04',
    title: 'Pose de revêtements',
    intro: 'Du sol au plafond, je pose tous types de revêtements intérieurs. Parquet, papier peint, sol souple… votre intérieur entièrement transformé.',
    points: [
    ...
    detail: 'La pose de revêtements est un métier de précision. Je travaille avec soin pour obtenir des raccords parfaits, des joints propres et un résultat esthétique qui durera dans le temps.',
  },
]
    ...
    <>
      ...
      <section className="bg-slate py-20">
        <div className="container-site">
          ...
          <motion.p
            className="text-cream/60 text-xl max-w-2xl leading-relaxed"
        ...
        >
          <div className="container-site">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              {/* Liste bullet */}
              <motion.div
                className={`border-2 border-border bg-white p-8 ${i % 2 === 1 ? 'lg:order-1' : ''}`}
                initial={{ opacity: 0, x: 30 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
              ...
              >
                ...
                <ul className="space-y-4">
                  {service.points.map((point, j) => (
                    <motion.li
                      key={point}
                      className="flex items-start gap-4 text-base text-dark"
        ...
        <div className="container-site">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              >
                <Link href={link.href} className="flex items-center justify-between p-6 border-2 border-border hover:border-terra hover:text-terra transition-colors group">
