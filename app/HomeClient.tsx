    ...
    >
      ...
      <div className="container-site relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-end pb-20 pt-8">
          ...
          <div>
            <motion.span
              className="section-tag text-terra/90"
            ...
            <motion.p
              className="text-cream/70 text-lg leading-relaxed mb-8 max-w-lg"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              className="bg-terra/20 border-l-4 border-terra px-6 py-4 mb-8"
